...
export datadir0=/lustre/orion/lrn070/world-shared/mlupopa/Supercomputing2025/HydraGNN/examples/ani1_x/dataset/ANI1x.bp
export datadir1=/lustre/orion/lrn070/world-shared/mlupopa/Supercomputing2025/HydraGNN/examples/qm7x/dataset/qm7x.bp
export datadir2=/lustre/orion/lrn070/world-shared/mlupopa/Supercomputing2025/HydraGNN/examples/mptrj/dataset/MPTrj.bp
export datadir3=/lustre/orion/lrn070/world-shared/mlupopa/Supercomputing2025/HydraGNN/examples/alexandria/dataset/Alexandria.bp
export datadir4=/lustre/orion/lrn070/world-shared/mlupopa/Supercomputing2025/HydraGNN/examples/transition1x/dataset/ransition1x.bp
...
#srun -N$SLURM_JOB_NUM_NODES -n$((SLURM_JOB_NUM_NODES*8)) -c7 --gpus-per-task=1 --gpu-bind=closest python -u ./examples/multibranch/train.py \
#--inputfile=gfm_multibranch.json --num_samples=400000 --multi --ddstore --multi_model_list=$datadir0,$datadir1 #,$datadir3,$datadir4
