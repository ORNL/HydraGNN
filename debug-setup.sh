...
#TRAINING
#srun -N$SLURM_JOB_NUM_NODES -n$((SLURM_JOB_NUM_NODES*8)) -c7 --gpus-per-task=1 --gpu-bind=closest python -u ./examples/multibranch/train.py --log=SC25_GFM_multibranch_login_EGNN --inputfile=multibranch_GFM260_SC25_direct_EGNN.json --num_samples=10000 --multi --ddstore --multi_model_list=$datadir1
