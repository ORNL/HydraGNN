...
#SBATCH -A LRN070
#SBATCH -J HydraGNN
#SBATCH -o SC25-basesingle1-%j.out
#SBATCH -e SC25-basesingle1-%j.out
#SBATCH -t 02:00:00
#SBATCH -p batch 
##SBATCH -q debug
#SBATCH -N 128 
...
srun -N$SLURM_JOB_NUM_NODES -n$((SLURM_JOB_NUM_NODES*8)) -c7 --gpus-per-task=1 --gpu-bind=closest python -u ./examples/multibranch/train.py --log=SC25_baseline_data1 \
--inputfile=baseline_GFM260_SC25.json --multi --ddstore --multi_model_list=$datadir1
