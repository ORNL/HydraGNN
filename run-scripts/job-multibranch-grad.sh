...
srun -N$SLURM_JOB_NUM_NODES -n$((SLURM_JOB_NUM_NODES*8)) -c7 --gpus-per-task=1 --gpu-bind=closest python -u ./examples/multibranch/train.py --log=SC25_GFM_multibranch_physics-informed_DimeNet \
--inputfile=multibranch_GFM260_SC25_physics-informed_DimeNet.json --multi --ddstore --multi_model_list=$datadir1
