...
class OGBRawDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        data = generate_graphdata_from_smilestr,(smilestr, ytarget, ogb_node_types, self.var_config)
        return data
    ...
    if args.preonly:
        ...
        for idataset, (smileset, valueset) in enumerate(zip(smiles_sets, values_sets)):
            ...
            for i, (smilestr, ytarget) in iterate_tqdm(
                ...
                data = generate_graphdata_from_smilestr,(smilestr, ytarget, ogb_node_types, var_config)
