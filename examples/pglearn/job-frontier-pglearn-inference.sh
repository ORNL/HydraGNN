...
#SBATCH -A LRN087
#SBATCH -J pglearn_in
#SBATCH -o pglearn-infer-%j.out
#SBATCH -e pglearn-infer-%j.out
#SBATCH -t 00:45:00
#SBATCH -p batch
#SBATCH -q debug
#SBATCH -N 1
...
INFER_SCRIPT=${INFER_SCRIPT:-infer_pglearn_solution_heterogeneous.py}
...
srun -N ${NHOSTS} \
    ...
    python -u "${INFER_SCRIPT}" ${FORMAT_FLAG} --modelname "${MODELNAME}" ${EXTRA_INFER_ARGS}
