#!/bin/bash
#SBATCH -A LRN070
#SBATCH -J OPF118-SAGE-ATTN
#SBATCH -o job-opf118-sage-attn-%A_%a.out
#SBATCH -e job-opf118-sage-attn-%A_%a.out
#SBATCH -t 02:00:00
#SBATCH -p batch
#SBATCH -N 8
#SBATCH --array=0-1
...
CONFIGS=(
    configs/opf_heterosage_case118_gps_bus_attention.json
    configs/opf_heterosage_case118_gps_all_attention.json
)
RUN_NAMES=(
...
echo "Dataset:       ${OPF_DIR}/dataset/case118.h5"
