#!/bin/bash
#SBATCH -A LRN070
#SBATCH -J OPF4661-ACDC-PRE
#SBATCH -o job-opf4661-acdc-rpe-pre-%j.out
#SBATCH -e job-opf4661-acdc-rpe-pre-%j.out
#SBATCH -t 02:00:00
#SBATCH -p batch
#SBATCH -N 8
...
CONFIG=configs/opf_heterosage_case4661_effective_impedance_rpe.json
