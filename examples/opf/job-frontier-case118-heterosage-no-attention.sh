#!/bin/bash
#SBATCH -A LRN070
#SBATCH -J OPF118-SAGE
#SBATCH -o job-opf118-sage-no-attn-%j.out
#SBATCH -e job-opf118-sage-no-attn-%j.out
#SBATCH -t 02:00:00
#SBATCH -p batch
#SBATCH -N 8
...
CONFIG=configs/opf_heterosage_case118_no_attention.json
RUN_NAME=case118_heterosage_no_attention
