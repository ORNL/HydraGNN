#!/bin/bash
#SBATCH -A LRN070
#SBATCH -J OPF4661-CTRL
#SBATCH -o job-opf4661-bus-attention-control-%j.out
#SBATCH -e job-opf4661-bus-attention-control-%j.out
#SBATCH -t 02:00:00
#SBATCH -p batch
#SBATCH -N 16
...
CONFIG=configs/opf_heterosage_case4661_bus_attention_control.json
RUN_NAME=case4661_bus_attention_control
...
if [[ ! -d "dataset/${DATASET_NAME}.h5" || ! -f "dataset/${DATASET_NAME}.h5/meta.h5" ]]; then
    echo "Missing dataset/${DATASET_NAME}.h5." >&2
    exit 1
fi
