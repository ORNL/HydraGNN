#!/bin/bash
# =============================================================================
#  Frontier Slurm job — FT1 Feasibility Classification (multi-method)
#
...
#           FT1_feasibility_classification/job-frontier-FT1-multi.sh
# =============================================================================
#SBATCH -A LRN070
#SBATCH -J OPF-FT1-MULTI
#SBATCH -o /lustre/orion/lrn078/proj-shared/HydraGNN/FT1-multi-%j.out
#SBATCH -e /lustre/orion/lrn078/proj-shared/HydraGNN/FT1-multi-%j.out
#SBATCH -t 02:00:00
#SBATCH -p batch
#SBATCH -N 32
...
echo "============================================================"
echo " FT1 Feasibility Classification — multi-method job"
...
_launch() {
    ...
    local LOG_NAME="FT1_feasibility_${FT_ARCH}_${REGIME}${_scratch_tag}${_n_tag}"
