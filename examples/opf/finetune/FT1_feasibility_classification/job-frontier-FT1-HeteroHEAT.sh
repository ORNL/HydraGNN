#!/bin/bash
# =============================================================================
#  Frontier Slurm job — FT1 Feasibility Classification (HeteroHEAT)
#
...
#
#  NOTE: If HeteroSAGE Phase 1 has already run (FT1_feasibility_data.h5
#  already exists), set PHASES=train to skip regeneration.
#
#  Usage:
#    sbatch job-frontier-FT1-HeteroHEAT.sh
#
...
# -----------------------------------------------------------------------------
FT_ARCH=HeteroHEAT
FT_REGIME=${FT_REGIME:-full}
PRETRAINED_MODEL=${PRETRAINED_MODEL:-HeteroHEAT_best}
PHASES=${PHASES:-preonly,train}
