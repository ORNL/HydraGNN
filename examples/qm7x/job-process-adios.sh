...
#SBATCH -A LRN070
#SBATCH -J HydraGNN
#SBATCH -o job-adios-preprocess-%j.out
#SBATCH -e job-adios-preprocess-%j.out
#SBATCH -t 04:00:00
#SBATCH -p batch
##SBATCH -q debug
#SBATCH -N 16 #1
...
# source /lustre/orion/lrn070/world-shared/rylieweaver/miniconda/etc/profile.d/conda.sh
conda deactivate
# conda activate hydragnn_rocm624
conda activate hydragnn_andes
# conda activate andes_latest
...
#Preonly Andes
srun -N$SLURM_JOB_NUM_NODES -n$((SLURM_JOB_NUM_NODES*10)) -c3 python -u ./train.py --preonly
# srun -N$SLURM_JOB_NUM_NODES -n$((SLURM_JOB_NUM_NODES*2)) -c2 --gpus-per-task=1 --gpu-bind=closest python -u ./train.py --preonly

# # PreOnly Frontier
# srun -N$SLURM_JOB_NUM_NODES -n$((SLURM_JOB_NUM_NODES*8)) -c7 --gpus-per-task=1 --gpu-bind=closest python -u ./train.py --preonly