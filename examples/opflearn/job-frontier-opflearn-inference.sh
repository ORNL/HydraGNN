#!/bin/bash
#SBATCH -A LRN087
#SBATCH -J opflearn_in
#SBATCH -o opflearn-infer-%j.out
#SBATCH -e opflearn-infer-%j.out
#SBATCH -t 00:45:00
#SBATCH -p batch
#SBATCH -q debug
#SBATCH -N 1
...
INFER_SCRIPT=${INFER_SCRIPT:-infer_opflearn_solution_homogeneous.py}
...
srun -N ${NHOSTS} \
    ...
    python -u "${INFER_SCRIPT}" --modelname "${MODELNAME}" ${EXTRA_INFER_ARGS}
