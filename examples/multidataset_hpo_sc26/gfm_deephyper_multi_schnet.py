...
MPNN_TYPE = "SchNet"
WRAPPED_SCRIPT = os.path.join(os.path.dirname(__file__), "gfm_mlip_schnet.py")
...
if __name__ == "__main__":
    ...
    problem.add_hyperparameter((6, 2000), "num_filters")
    problem.add_hyperparameter((3, 24), "num_gaussians")
