...
MPNN_TYPE = "MACE"
WRAPPED_SCRIPT = os.path.join(os.path.dirname(__file__), "gfm_mlip_mace.py")
...
def run(trial, dequed=None):
    ...
    command = " ".join(
        [
            ...
            f"--radial_type={trial.parameters['radial_type']}",
            f"--distance_transform={trial.parameters['distance_transform']}",
            f"--num_radial={trial.parameters['num_radial']}",
            f"--max_ell={trial.parameters['max_ell']}",
            f"--node_max_ell={trial.parameters['node_max_ell']}",
            f"--correlation={trial.parameters['correlation']}",
...
if __name__ == "__main__":
    ...
    problem.add_hyperparameter(["Agnesi", "Soft"], "distance_transform")
    problem.add_hyperparameter((3, 12), "num_radial")
    problem.add_hyperparameter((2, 3), "max_ell")
    problem.add_hyperparameter((1, 3), "node_max_ell")
    problem.add_hyperparameter((2, 3), "correlation")
