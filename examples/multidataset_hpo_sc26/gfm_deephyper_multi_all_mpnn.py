...
def run(trial, dequed=None):
    ...
    command = " ".join(
        [
            ...
            f"--multi",
            f"--ddstore",
            f'--multi_model_list="Alexandria,ANI1x,MPTrj,OC2020,OC2022,ODAC23,OMat24,OMol25,OC2025,OPoly2026,Nabla2DFT,QCML,qm7x,transition1x"',
            ## debugging
...
if __name__ == "__main__":
    ...
    problem.add_hyperparameter((10.0, 1000.0), "force_weight")  # continuous parameter
    problem.add_hyperparameter((1e-5, 3e-3), "learning_rate", log=True)  # log-scale
