...
# Load conda environemnt
source module-to-load-frontier.sh
setup_bb
...
MPNN_LIST="EGNN SchNet DimeNet MACE PAINN PNAEq"
...
python -u $HYDRAGNN_ROOT/examples/multidataset_hpo_sc26/gfm_mlip_all_mpnn.py \
    --log=multidataset_hpo-$SLURM_JOB_ID-NN$SLURM_JOB_NUM_NODES-FSDP$HYDRAGNN_USE_FSDP-$MPNN --everyone \
