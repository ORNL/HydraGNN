...
import hydragnn.utils.model.uma._vendored.fairchem.core
...
def setup_imports(config: dict | None = None) -> None:
    ...
    try:
        ...
        importlib.import_module("hydragnn.utils.model.uma._vendored.fairchem.core.common.logger")
...
def _resolve_scale_factor_submodule(model: nn.Module, name: str):
    from hydragnn.utils.model.uma._vendored.fairchem.core.modules.scaling.scale_factor import ScaleFactor
...
def get_commit_hash() -> str:
    core_hash = get_commit_hash_for_repo(hydragnn.utils.model.uma._vendored.fairchem.core.__path__[0])
