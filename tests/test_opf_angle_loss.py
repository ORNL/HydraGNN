...
def test_wrapped_angle_difference_uses_short_path():
...
def test_circular_angle_mse_uses_wrapped_residual():
...
def test_uniform_offset_is_penalized_to_preserve_reference_convention():
